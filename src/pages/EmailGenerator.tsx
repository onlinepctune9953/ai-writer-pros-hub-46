  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Generate Emails Instantly</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Use our AI-powered tool to create personalized, high-converting email campaigns in seconds.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <form className="space-y-6">
              <div>
                ...
                <Input placeholder="Enter your email subject" type="text" className="w-full" />
              </div>

              <div>
                <label className="block text-sm font-medium mb-2">Email Content</label>
                <textarea
                  placeholder="Describe the purpose of your email (e.g., promotion, welcome message)"
            ...
            <div className="mt-8">
              <h3 className="text-lg font-bold mb-4">Generated Email</h3>
